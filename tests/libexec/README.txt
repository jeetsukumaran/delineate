...
one can run:
    ...
    python joint_from_all_scenarios.py example/five_leaf.tre 0.02
...
is found in `efficient_joint_prob.py`:
    ...
    python efficient_joint_prob.py example/five_leaf.tre 0.02
...
If you just want the probability of one subset of leaves being recognized
    ...
    python marginal_prob.py example/five_leaf.tre .02 a c e
...
## Tests
    ...
    ./check.sh ../data/five_leaf.tre 0.02
